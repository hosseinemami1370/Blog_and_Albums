...
<button class="btn btn-primary" @click="showComment(loadedPost.id)">Show Comment</button>
    ...
    <section  v-if="showComments" class="post-feedback">
      ...
      :body="comment.body"
       />
      <p class="col-lg-8">Let me know what you think about the post, send a mail to <a href="mailto:feedback@my-awesome-domain.com">feedback@my-awesome-domain.com</a>.</p>
    </section>
