<template>
  <div class="single-post-page">
    <section class="post">
      ...
      <div class="generalcontainer" style="padding-top: 15px; margin-top: 10px; padding-bottom: 25px; font-size: 14px;"> <!----> <a class="button button-tag-mid u-full-width projectcomments" style="margin-top: 5px;"><span>Show comments</span> <!----></a></div>
    </section>
